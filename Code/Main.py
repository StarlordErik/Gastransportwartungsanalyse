...
def main():
    ...
    url = "https://transparency.entsog.eu/api/v1/operationalData.csv"  # wenn man ".csv" entfernt, bekommt man eine JSON
    ...
    # es wird ein bestimmtes Unternehmens-Zertifikat im Unternehmen benötigt
    zertifikat = os.path.join(projektordner, "Einstellungen", "Zertifikat.crt")
